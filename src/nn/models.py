...
from src.detection import threshold_optimization
from src.detection.metrics import matching_with_list
from src.detection.metrics import metric_vs_iou_macro_average, metric_vs_iou_micro_average
from src.detection.metrics import average_metric_macro_average, average_metric_micro_average
from src.detection.feeder_dataset import FeederDataset
from src.nn.base_model import BaseModel
from src.nn.base_model import KEY_LOSS
from src.nn import networks, networks_v2, networks_v3
from src.nn import losses, optimizers, metrics, augmentations
...
class WaveletBLSTM(BaseModel):
    ...
    def __init__(self, params=None, logdir='logs'):
        ...
        feat_train_shape = [int(augmented_input_length)]
        label_train_shape = feat_train_shape
        feat_eval_shape = [int(page_size + 2 * border_size)]
        label_eval_shape = [int(page_size / time_stride)]
        super().__init__(
            feat_train_shape,
            label_train_shape,
            feat_eval_shape,
