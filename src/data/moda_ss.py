...
from src.data import stamp_correction
from src.data.dataset import Dataset
from src.data.dataset import KEY_EEG, KEY_MARKS
from src.data.dataset import KEY_N2_PAGES, KEY_ALL_PAGES, KEY_HYPNOGRAM
...
class ModaSS(Dataset):
    """This is a class to manipulate the MODA data EEG dataset.
    The MODA data is assumed to be prepared at resources/datasets/moda/.
    In particular, it expects the existence of segments/moda_preprocessed_segments.npz
    (see moda/generate_moda_segments.py)
    """
