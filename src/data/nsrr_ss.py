...
from src.data.dataset import KEY_EEG, KEY_N2_PAGES, KEY_ALL_PAGES, KEY_MARKS, KEY_HYPNOGRAM
...
class NsrrSS(Dataset):
    ...
    The NSRR data is assumed to be prepared at resources/datasets/nsrr/
    (see nsrr/prepare_data.py)
    """
