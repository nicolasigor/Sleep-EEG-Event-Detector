"""This script extracts only the relevant data from the full MODA database to save storage.
It saves the extracted signal for each subject in independent files under
