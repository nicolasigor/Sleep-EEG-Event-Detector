...
if __name__ == "__main__":
    ...
    for subject_id in subject_ids:
        ...
        if labeled_pages != total_pages:
            print(
                "Subject %s, hypno: %d labels, epochLength %s, first start %s, last start %s, required labels %s"
                % (
                    subject_id,
                    len(stage_labels),
                    epoch_length,
        ...
        if channel_found is None:
            print(
                "Subject %s without valid channels. Full list:" % subject_id,
                channel_names,
            )
        else:
            ...
            if len(channel_found) == 2:
                ...
                channel_name_2 = ""
                channel_fs_2 = ""
            channel_str = "%s minus %s, fs %s minus %s" % (
                channel_name_1,
                channel_name_2,
                channel_fs_1,
                channel_fs_2,
